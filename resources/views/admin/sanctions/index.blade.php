...
@section('content')
    <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        ...
        <div class="flex flex-col items-stretch gap-3 sm:flex-row sm:items-center">
            <a href="{{ route('admin.sanctions.create') }}" class="btn btn-primary inline-flex items-center gap-2 shadow-sm font-semibold" style="background: linear-gradient(135deg, #0ea5e9, #0284c7); color: #ffffff !important; border: none; padding: 0.45rem 1rem;">
